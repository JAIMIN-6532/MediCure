...
function Filter({ filters, onFilterChange }) {
  const specialties = ["Cardiologist", "Neurologist", "Pediatrician", "Dermatologist", "Orthopedic"];
      ...
      <div className="mb-6">
        ...
        <div className="flex gap-1">
          {[1, 2, 3, 4, 5].map((rating) => (
            ...
            >
              <svg className="w-6 h-6 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 17.75l-5.24 3.28 1.49-6.43-4.9-4.24 6.42-.53L12 2l2.23 7.81 6.42.53-4.9 4.24 1.49 6.43z"/></svg>
            </button>
          ))}
        </div>
      </div>
