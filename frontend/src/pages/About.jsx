    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-blue-50 py-16 px-4 sm:px-6 lg:px-8 pt-16">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-20">
          <h1 className="text-5xl font-bold mb-8 bg-gradient-to-r from-gray-900 via-blue-800 to-gray-900 bg-clip-text text-transparent">
            Connecting Healthcare
          </h1>
          <p className="text-2xl text-gray-600 max-w-3xl mx-auto">
            Bridging the gap between patients and healthcare professionals through innovative technology
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-24">
          <div className="bg-white/80 backdrop-blur-lg rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all hover:-translate-y-2">
            ...
            <p className="text-gray-600">All healthcare professionals on our platform are thoroughly verified and credentialed.</p>
          </div>
          <div className="bg-white/80 backdrop-blur-lg rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all hover:-translate-y-2">
            <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mb-6">
              <svg className="w-8 h-8 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="bg-white/80 backdrop-blur-lg rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all hover:-translate-y-2">
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-4">Secure Consultations</h3>
            <p className="text-gray-600">End-to-end encrypted video consultations ensuring your privacy and confidentiality.</p>
          </div>
        </div>
